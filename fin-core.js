 ...
 * [release] Fin 4.9.8 — dashboard hierarchy redesign
 */
(function (g) {
  'use strict';
  var api = g.FinApp || {};
  ...
  function loadScripts(){
    ...
    if(!document.querySelector('script[data-fin-design]')){var d=document.createElement('script');d.src='fin-design.js?v=2026090427';d.async=true;d.setAttribute('data-fin-design','1');(document.head||document.documentElement).appendChild(d);}
  }
