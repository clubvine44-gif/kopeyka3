...
function addStyle(){
  ...
  s.textContent=''+
    ...
    '#voiceModal .voice-actions{display:flex!important;visibility:visible!important;opacity:1!important;gap:8px!important;margin-top:14px!important;width:100%!important;position:relative!important;z-index:9999!important;flex-wrap:wrap!important}'+
    '#voiceModal .voice-actions .voice-btn{display:flex!important;visibility:visible!important;opacity:1!important;flex:1!important;min-height:48px!important;min-width:90px!important;align-items:center!important;justify-content:center!important;padding:12px 10px!important;border-radius:12px!important;background:#1C1F28!important;border:1px solid rgba(255,255,255,.14)!important;color:#F2F3F7!important;font-size:15px!important;font-weight:700!important}'+
    ...
    '#voiceModal .voice-actions .voice-btn.danger{background:rgba(248,113,113,.15)!important;color:#F87171!important;border:1px solid rgba(248,113,113,.35)!important}';
...
function ensureConfirmVisibility(){
  ...
  if(!modal) return;
  var actions=modal.querySelector('.voice-actions');
  if(actions){
