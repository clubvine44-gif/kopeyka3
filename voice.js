...
load('ai.js?v=7',function(){load('assistant.js?v=1',function(){muteSpeech();if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',addButton);else addButton();});});
})();
